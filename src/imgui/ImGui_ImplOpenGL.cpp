...
//  fail if the function is a nullptr pointer. 2018-03-06: OpenGL: Added const char* glsl_version
//  parameter to Init() so user can override the GLSL version e.g. "#version 150".
...
//  and exposed ImplSdlGL3_RenderDrawData() in the .h file so you can call it yourself.
...
bool Init(const char* glsl_version)
{
    ...
    // version is NOT the same as GL version. Leave this to nullptr if unsure.
